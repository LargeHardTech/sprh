...
namespace sprh
{
    internal static class Help
    {
        ...
        {
            PrintHelp(interactive: false);
        }

        /// <summary>
        /// 统一输出帮助信息。
        /// interactive=false 时一次性输出，不分页等待按键。
        /// </summary>
        private static void PrintHelp(bool interactive)
        {
            // ──────────── 第1屏 ────────────
            PrintHeader();
            PrintUsage();

            if (interactive) NextPage();

            // ──────────── 第2屏 ────────────
            PrintSection("指令详表", null);
            PrintMoveSection();
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("  -ver, -version  显示版本号");
            Console.WriteLine("  /?              显示本帮助");
            Console.WriteLine();
            Console.WriteLine("示例：");
            Console.WriteLine("  sprh test.sprh -d -s");
            Console.WriteLine("  sprh test.sprh -c output.cpp");
            Console.WriteLine();
        ...
        private static void PrintSection(string title, string? subtitle)
        {
            if (subtitle != null)
            {
        ...
        private static void PrintMoveSection()
        {
            PrintSection("指令详表", null);
        ...
        private static void PrintArithSection()
        {
        ...
        private static void PrintAssignSection()
        {
            Console.WriteLine("3. 赋值与输出");
            Console.WriteLine("   =?    将 ASCII 字符 ? 写入当前单元格");
            Console.WriteLine("   Pc    以字符形式输出当前单元格的值");
            Console.WriteLine("   Pi    以整数形式输出当前单元格的值");
            Console.WriteLine("   Pl    显示 SPRH Logo（ASCII Art）");
            Console.WriteLine();
        }

        private static void PrintVariableSection()
        {
        ...
        private static void PrintStackSection()
        {
        ...
        private static void PrintBitwiseSection()
        {
        ...
        private static void PrintInputSection()
        {
            Console.WriteLine("7. 控制台输入操作");
        ...
        private static void PrintFileSection()
        {
            Console.WriteLine("8. 文件操作");
            Console.WriteLine("   默认输入文件 input.spri，默认输出文件 output.spro。");
            Console.WriteLine("   ── 文件名操作 ──");
            Console.WriteLine("   F<    将当前单元格的 ASCII 字符追加到输入文件名末尾");
            Console.WriteLine("   F>    将当前单元格的 ASCII 字符追加到输出文件名末尾");
            Console.WriteLine("   F[    清空输入文件名（恢复为空字符串）");
            Console.WriteLine("   F]    清空输出文件名（恢复为空字符串）");
            Console.WriteLine("   ── 文件读取运算 ──");
            ...
            Console.WriteLine("        文件名操作在解释器/编译器中均有效。");
            Console.WriteLine();
        }

        private static void PrintJumpSection()
        {
        ...
        private static void PrintConditionJumpSection()
        {
            ...
            Console.WriteLine("   x 为方向：u（上）、d（下）、l（左）、r（右）");
            Console.WriteLine("   相邻单元格必须存在，否则报缓冲区溢出。");
            Console.WriteLine("   支持多层嵌套，解释器和编译器均已正确处理嵌套配对。");
            Console.WriteLine();
        }

        private static void PrintMiscSection()
        {
            Console.WriteLine("11. 其他");
            Console.WriteLine("   /* */ 注释块（不支持嵌套）");
            Console.WriteLine("   /] /} /) 条件跳转的闭括号标记（空操作，仅用于配对）");
            Console.WriteLine();
        }
        ...
        private static void PrintExamples()
        {
            ...
            Console.WriteLine("【嵌套条件跳转示例】");
            Console.WriteLine("双层循环结构：");
            Console.WriteLine("  +1          // 外层计数器加1");
            Console.WriteLine("  [u +1       // 内层循环：上方单元格加1");
            Console.WriteLine("    [u /]     //   内层条件跳转标记");
            Console.WriteLine("  /]          // 外层条件跳转标记");
            Console.WriteLine();
